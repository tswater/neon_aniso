...
text_dir='/home/tsw35/soteria/data/NEON/download_prep/textfiles'
...
for site in sitelist[rank::size]:
    os.chdir('/home/tsw35/soteria/data/NEON/raw_data/'+site)
    cmd = 'wget -c --progress=dot -i '+text_dir+'/'+site+'.txt'
    print(cmd)
