...
text_dir='/home/tsw35/soteria/data/NEON/download_prep/textfiles4'
...
for site in list(sites.keys())[rank::size]:
    try:
        subprocess.run('mkdir ../'+'dp04/'+site,shell=True)
    except:
        pass
...
for site in list(sites.keys())[rank::size]:
    os.chdir('/home/tsw35/soteria/data/NEON/dp04/'+site)
