...
for site in list(sites.keys())[rank::size]:
    try:
        subprocess.run('mkdir ../'+'precip/'+site,shell=True)
    except:
        pass
    ...
    for i in range(dt):
        ...
        if m_date.month==om:
            ...
            om=m_date.month
        wstr="https://data.neonscience.org/api/v0/data/package/DP1.00006.001/"
...
for site in list(sites.keys())[rank::size]:
    ...
    os.chdir('/home/tsw35/soteria/data/NEON/precip/'+site)
