...
case['scale']     = 5 # scale for the case
case['l1dir']     = '/home/tswater/tyche/data/neon/L1/neon_5m/' # l1 directory for input
case['fpath']     = '/home/tswater/tyche/data/neon/L2/L2_ybd/ybd_stable5.h5' # filepath
...
case['limvars']   ={'ST_UsUs_1':[-1,50],'ST_VsVs_1':[-1,50],'USTAR/Us':[.05,100]} # dictionary of VAR:[MIN,MAX] pairs; limits must be met
