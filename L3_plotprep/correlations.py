...
fxns={0:{'AD_MOST_U':u_most_u,'AD_MOST_V':u_most_v,'AD_MOST_W':u_most_w,\
        'AD_SC23_U':u_sc23_u,'AD_SC23_V':u_sc23_v,'AD_SC23_W':u_sc23_w,\
        'AD_TSW_U':u_tsw_u,'AD_TSW_V':u_tsw_v,'AD_TSW_W':u_tsw_w,},
      1:{'AD_MOST_U':s_most_u,'AD_MOST_V':s_most_v,'AD_MOST_W':s_most_w,\
        'AD_SC23_U':s_sc23_u,'AD_SC23_V':s_sc23_v,'AD_SC23_W':s_sc23_w,\
...
for i in [1]:
    ...
    if i==0:
        pickle.dump(d_unst,open('/home/tswater/Documents/Elements_Temp/NEON/neon_processed/L3_plotting_data/d_corr_ust_v1.p','wb'))
    else:
        pickle.dump(d_stbl,open('/home/tswater/Documents/Elements_Temp/NEON/neon_processed/L3_plotting_data/d_corr_stb_v1.p','wb'))
