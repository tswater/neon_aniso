# same as raw_multi.py, except only outputing velocities (non-streamwise)
...
out_dir='/home/tsw35/soteria/data/NEON/multiscale_uvwfix/'
sites=['ALL']
years=['ALL']
scales=[1,2,5,10,15,20,30,45,60,90,120,180]
cvars=['UU','VV','UV','UW','VW']
...
#                # mean remove
                wp=ld_w[i0:ie]-np.nanmean(ld_w[i0:ie])
