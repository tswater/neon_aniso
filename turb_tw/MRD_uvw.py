...
tctf=120 #minimum length of time to count in minutes

idir='/home/tswater/tyche/data/neon/raw_streamwise/'
odir='/home/tswater/tyche/data/neon/mrd/'
...
for site in sites[rank::size]:
    ...
    fps=h5py.File('/home/tswater/Documents/Elements_Temp/NEON/neon_1m/'+site+'_L1.h5','r')
    time=fps['TIME'][:]
