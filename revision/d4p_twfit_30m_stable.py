...
letters=['a','b','c','d']
lg={'Uu':[True],'Vu':[True], 'Wu':[True],'Us':[False,False],'Vs':[False,False],'Ws':[False,False]}
...
fxns_={'Us':U_stb,'Vs':U_stb,'Ws':U_stb}
...
for var in fxns_.keys():
    ...
    fname='/home/tswater/Documents/Elements_Temp/NEON/neon_processed/L2_qaqc_data_v2/NEON_TW_S30.h5'
    d_=d_stbl
...
pickle.dump(d_stbl,open('/home/tswater/Documents/Elements_Temp/NEON/neon_processed/L3_plotting_data/d_stbl_tw_30ms.p','wb'))
